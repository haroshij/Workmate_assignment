...
<br>
<img width="1063" height="239" alt="image" src="https://github.com/user-attachments/assets/bcd968a9-0d57-48e8-a20b-372ca89a1ff8" />
<br><br>
...
<code>test_main.py</code> - скрипт для тестирования<br>
<code>main(func).py</code> - скрипт, выполняющий то же действие, но без ООП (не оттестирован,  приложен для примера)<br>
